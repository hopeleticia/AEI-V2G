...
|---|---|---|---|---|---|---|---|---|---|
| weekday_nominal | PASS | PASS | PASS | PASS | PASS | PASS | PASS | FAIL | FAIL |
| evening_peak_v2g | PASS | PASS | PASS | PASS | PASS | PASS | PASS | FAIL | FAIL |
| event_surge | PASS | PASS | PASS | PASS | PASS | PASS | PASS | FAIL | FAIL |
| rural_degraded_isac | PASS | PASS | PASS | PASS | PASS | PASS | PASS | FAIL | FAIL |
| wan_outage_edge_only | PASS | PASS | PASS | PASS | PASS | PASS | PASS | FAIL | FAIL |
...
- blockchain_settlement block is missing from detail.components
- blockchain_settlement block is missing from detail.components
- blockchain_settlement block is missing from detail.components
- blockchain_settlement block is missing from detail.components
- blockchain_settlement block is missing from detail.components
