...
def apply_v2g(
    ...
    ledger = credit_client if credit_client is not None else _credit_client()
        ...
        for ev in station.active_evs:
            ...
            if ev.battery_pct >= 62:
                ...
                if ledger is not None:
                    ...
                    if settlement["credit_ledger_tx_hash"]:
    ...
    return {
        ...
        "credit_ledger_mode": "on_chain" if ledger is not None else "local_hash_only",
